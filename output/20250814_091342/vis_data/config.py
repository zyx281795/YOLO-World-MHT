...
custom_imports = dict(
    ...
    imports=[
        'yolo_world',
        'yolo_world.models.layers.yolov11_blocks',
        'yolo_world.models.backbones.yolov11_backbone',
    ])
data_root = 'data/coco/'
...
load_from = 'checkpoints/yolo_world_v2_x_obj365v1_goldg_cc3mlite_pretrain_1280ft-14996a36.pth'
log_level = 'INFO'
...
model = dict(
    backbone=dict(
        image_model=dict(
            ...
            arch='P5',
            c2psa_attention=True,
            c3k2_blocks=True,
            deepen_factor=1.25,
            last_stage_out_channels=512,
            norm_cfg=dict(eps=0.001, momentum=0.03, type='BN'),
            type='YOLOv8CSPDarknet',
            use_yolov11_blocks=True,
            widen_factor=1.25),
        text_model=dict(
            frozen_modules=[
                'all',
    ...
    neck=dict(
        act_cfg=dict(inplace=True, type='SiLU'),
        block_cfg=dict(
            type='MaxSigmoidCSPLayerWithTwoConv', use_yolov11_blocks=True),
        deepen_factor=1.25,
        embed_channels=[
            128,
            256,
